...
str2UZPP2s (y:ys)
  | getBFst' (False, V.fromList [('a',True),('e',True),('i',True),('o',True),('u',True),('y',True)]) y = UZ y W:str2UZPP2s ys
  | y == 'D' || y == 'w' = UZ y N:str2UZPP2s ys
  | (null ys || head ys /= 'q') && getBFst' (False, V.fromList [('C',True),('l',True),('m',True),('n',True),('r',True),('v',True)]) y =
       UZ y S:str2UZPP2s ys
  | (null ys || head ys /= 'q') &&
      getBFst' (False, V.fromList [('A',True),('B',True),('b',True),('d',True),('g',True),('h',True),('j',True),('z',True)]) y =
        UZ y D:str2UZPP2s ys
  | (null ys || head ys /= 'q') = UZ y L:str2UZPP2s ys
  | getBFst' (False, V.fromList [('l',True),('m',True),('n',True),('r',True),('v',True)]) y = UZ y O:str2UZPP2s (drop 1 ys)
  | getBFst' (False, V.fromList [('A',True),('B',True),('b',True),('d',True),('g',True),('h',True),('j',True),('z',True)]) y =
...
uzpp2Durat3 = X.getBFst' (0.05779993, VB.fromList [(UZ 'A' D, 0.08453724), (UZ 'A' K, 0.08453724),
