-- |
-- Module      :  Languages.Phonetic.Ukrainian.Syllable.Double
...
module Languages.Phonetic.Ukrainian.Syllable.Double where
...
str2DuratD1 = X.getBFst' ((0.153016), VB.fromList [("-", (0.101995)), ("0", (0.051020)), ("1", (0.153016)), ("а", 0.138231), ("б", 0.057143),
...
uzpp2DuratD2 = X.getBFst' (0.06408817,VB.fromList [(UZ 'A' D, 0.07729654), (UZ 'A' K, 0.07729654), (UZ 'B' D, 0.08048113), (UZ 'B' K, 0.08048113),
...
uzpp2DuratD1 = X.getBFst' (0.051020, VB.fromList [(UZ 'A' D, 0.055601), (UZ 'A' K, 0.055601), (UZ 'B' D, 0.070658), (UZ 'B' K, 0.070658), (UZ 'C' S, 0.057143), (UZ 'D' N, 0.074558),
...
uzpp2DuratD3 = X.getBFst' (0.05779993, VB.fromList [(UZ 'A' D, 0.08453724), (UZ 'A' K, 0.08453724),
